-- communication_db (idempotent) — apply: psql -d communication_db -f communication.sql
CREATE EXTENSION IF NOT EXISTS pgcrypto;

DO $$ BEGIN CREATE TYPE conversation_type AS ENUM ('donor_group', 'receiver_group');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE participant_type AS ENUM ('user', 'group');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE message_type AS ENUM ('text', 'image', 'system');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
