...
function createRouter({ listingController, requestController, statsController, listingImageController }) {
  ...
  router.post('/listings/:id/images', (req, res) => listingImageController.addImages(req, res));
  router.delete('/images/:imageId', (req, res) => listingImageController.deleteImage(req, res));
  ...
  router.get('/requests/:id/confirmation', (req, res) => requestController.getDeliveryConfirmation(req, res));
